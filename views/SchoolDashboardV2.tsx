  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          <button 
            ...
            className="bg-brand-purple hover:opacity-90 text-white px-6 py-3 rounded-[10px] font-black text-xs uppercase italic tracking-widest transition-all shadow-lg shadow-brand-purple/10 active:scale-95 flex items-center gap-2"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-[10px] border border-slate-100 shadow-sm flex items-center justify-between transition-all hover:shadow-md">
          <div>
          ...
          <div className="w-14 h-14 bg-sky-50 rounded-[10px] flex items-center justify-center text-sky-500 shadow-inner">
            <Calendar size={28} />
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-[10px] border border-slate-100 shadow-sm flex items-center justify-between transition-all hover:shadow-md">
          ...
          <div className="w-14 h-14 bg-emerald-50 rounded-[10px] flex items-center justify-center text-emerald-500 shadow-inner">
        ...
        <div className="bg-white p-6 rounded-[10px] border border-slate-100 shadow-sm flex items-center justify-between transition-all hover:shadow-md">
          ...
          <div className="w-14 h-14 bg-brand-purple/5 rounded-[10px] flex items-center justify-center text-brand-purple shadow-inner">
            <DollarSign size={28} />
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-[10px] border border-slate-100 shadow-sm flex items-center justify-between transition-all hover:shadow-md">
          ...
          <div className="w-14 h-14 bg-amber-50 rounded-[10px] flex items-center justify-center text-amber-500 shadow-inner">
            ...
            {recentEnrollments.map(athlete => (
              <div key={athlete.id} className="flex items-center justify-between p-5 bg-white border border-slate-100 rounded-[10px] hover:shadow-md transition-all hover:border-brand-purple/10">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-brand-purple/5 rounded-[10px] flex items-center justify-center text-brand-purple font-black italic shadow-inner">
